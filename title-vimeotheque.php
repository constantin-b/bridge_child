					...
					<div class="container">
						<div class="container_inner clearfix">
								...
								<?php } ?>
									...
									<?php } ?>
									<h1 <?php print bridge_qode_get_module_part( $bridge_qode_page_title_animation_data ); if(get_post_meta($id, "qode_page-title-color", true)) { ?> style="color:<?php echo get_post_meta($id, "qode_page-title-color", true) ?>" <?php } ?>><span><?php vimeotheque_qode_title_text(); ?></span></h1>
